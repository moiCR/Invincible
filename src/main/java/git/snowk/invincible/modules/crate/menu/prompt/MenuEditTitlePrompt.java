...
@AllArgsConstructor
public class MenuEditTitlePrompt extends StringPrompt {

    private final Crate crate;

    @Override
    public void handleBegin(Player player) {
        sendMessage(player, "&eType the new title for the menu. Enter &6cancel &eto cancel the process.");
